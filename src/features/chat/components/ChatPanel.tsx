...
export function ChatPanel({
  ...
  return (
    <Card className={cn('flex min-h-[34rem] flex-col p-0', className)}>
      <header className="flex min-h-20 items-center gap-3 border-b border-line px-4 py-3 sm:px-5">
        {onBack ? (
          <Button
        ...
        {bookingHref ? (
          <Link
            className="ml-auto shrink-0 text-sm font-semibold text-brand-strong underline-offset-4 hover:underline"
            to={bookingHref}
          >
            Mở booking
          </Link>
